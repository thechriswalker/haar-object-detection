...
function loader(xmlString) {
    ...
    parse(xmlString, function(err, xml) {
        ...
        try {
            ...
            // prettier-ignore
            var moduleSource = "var classifier = new Float32Array([" + output + "]);\n" +
...
function createClassifierModuleFromTrainCascade(xml) {
    var cascade = path(obj, "opencv_storage", "cascade");
    var features = parseFeatures(query(cascade, "features"));
